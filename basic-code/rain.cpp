...
int trap(vector<int>& height) {
	// we will calculate for each i, how much water is going to be stored at that height
	// for each i calculate the maximum at the left and right, then the water filled at i will be min(maxleft,maxright)-h[i]
	// maxheight right calculation, loop from backwards and put the logic :-)
	// maxheight left loop forward
	int n = height.size();
