...
// 	for(auto x: m){
// 		if(x.ff <= n - x.ss){ // x.ff = itna ya isse jyada liars h  n-x.ss = number of people except the one who says that x.ff st last liars -> wrong approach -> because ewe are predicting all ther are liar
// 			cout<<n-x.ss<<endl;
// 			return;
// 		}
// 	}
